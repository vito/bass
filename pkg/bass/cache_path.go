...
var _ Readable = CachePath{}

func (path CachePath) CachePath(_ctx context.Context, _dest string) (string, error) {
	return path.checkEscape()
}

func (path CachePath) Open(context.Context) (io.ReadCloser, error) {

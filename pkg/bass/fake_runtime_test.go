...
var _ bass.Runtime = &FakeRuntime{}

func (fake *FakeRuntime) Resolve(context.Context, bass.ImageRef) (bass.Thunk, error) {
	return bass.Thunk{}, fmt.Errorf("Resolve unimplemented")
}
